...
import { createExpenseValidator, sanitizeFormData, validateFile } from "@/lib/validation"
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function ExpenseForm({ isOpen, onClose, onSubmit, loading = false, directorCities = [], directorName = "Директор" }: ExpenseFormProps) {
  ...
  // Предопределенные варианты назначения платежа
  ...
  const validator = createExpenseValidator()
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-600 mt-2">
            Добавьте информацию о расходе компании
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-6">
          ...
          <div className="space-y-3">
            ...
            {!receiptFile ? (
              <div
                className={`relative border-2 border-dashed rounded-lg p-6 transition-all duration-200 cursor-pointer hover:border-red-400 hover:bg-red-50/50 ${
                  dragActive 
          ...
          <DialogFooter className="gap-3 pt-6">
            ...
            <Button type="submit" disabled={loading} className="px-6 bg-red-600 hover:bg-red-700">
